...
static const struct ath12k_hw_params ath12k_wifi7_hw_params[] = {
	...
	{
		/*
		 * peach (WCN7860) - WiFi-7 (PCIe 17cb:110e). Closest to QCC2072
		 * (same register remap window 0x3278), so it uses the QCC2072
		 * hw_ops + HAL (ops/desc/regs); the rest (ring/CE/MHI/WMI/QMI)
		 * is shared with WCN7850 exactly as QCC2072 does.
		 */
		.name = "wcn7860 hw2.0",
		...
		.qmi_cnss_feature_bitmap = BIT(CNSS_DRV_SUPPORT_V01) |
					   BIT(CNSS_WLAN_EN_SUPPORT_V01) |
